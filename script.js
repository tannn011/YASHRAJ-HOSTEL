...
function getEmbeddedData() {
  return {
    ...
    gallery: [
      { id: 1, src: "images/gallery-1.jpg", alt: "Hostel Front View", category: "exterior" },
      { id: 3, src: "images/gallery-3.jpg", alt: "Study Area", category: "common" },
      { id: 4, src: "images/gallery-4.jpg", alt: "Bedroom Interior", category: "rooms" },
      { id: 5, src: "images/gallery-5.jpg", alt: "Dining area", category: "dining" },
      { id: 6, src: "images/gallery-6.jpg", alt: "Bathroom Facilities", category: "rooms" },
      { id: 7, src: "images/gallery-7.jpg", alt: "Terrace", category: "exterior" },
    ],
    testimonials: [
...
function renderGallery() {
  ...
  siteData.gallery.forEach((item, index) => {
    ...
    galleryHTML += `
      <div class="gallery-item" data-category="${item.category}" data-index="${index}" data-alt="${item.alt}" data-src="${item.src}">
        <img
          src="${item.src}"
          alt="${item.alt}"
          loading="lazy"
...
function openLightbox(item) {
  ...
  // Set the image in lightbox
  let lightboxImg = document.getElementById('lightboxImage');
  if (!lightboxImg) {
    // Create image element if it doesn't exist
    lightboxImg = document.createElement('img');
    lightboxImg.id = 'lightboxImage';
    lightboxImg.style.cssText = 'max-width:100%; max-height:80vh; object-fit:contain; border-radius:8px;';
    const lightboxContent = lightbox.querySelector('.lightbox-content') || lightbox;
    lightboxContent.insertBefore(lightboxImg, lightboxContent.firstChild);
  }
