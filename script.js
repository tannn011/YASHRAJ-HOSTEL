...
function openLightbox(item) {
  ...
  // Set the image inside the existing lightbox-image-container
  ...
  if (!lightboxImg && lightboxContainer) {
    lightboxImg = document.createElement('img');
    lightboxImg.id = 'lightboxImage';
    lightboxImg.style.cssText = 'max-width:100%; max-height:75vh; object-fit:contain; border-radius:8px; display:block; margin:0 auto;';
